<?php
    ...
    $id_curso_actualizar = "";
    $titulo_actualizar_curso = "";
    $descripcion_actualizar_curso = "";
    $boton_actualizar_curso = "";

    if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['actualizar_curso'])){

        $id_curso_actualizar = $_POST["id_curso_actualizar"];
        $titulo_actualizar_curso = $_POST["titulo_actualizar_curso"];
        $descripcion_actualizar_curso = $_POST["descripcion_actualizar_curso"];
        $boton_actualizar_curso = $_POST["boton_actualizar_curso"];
        ...
        if(empty($errores_actualizar)){
            ...
            if($stmt == false){
                ...
                mysqli_stmt_bind_param($stmt, "sssi", $titulo_actualizar_curso, $descripcion_actualizar_curso, $boton_actualizar_curso, $id_curso_actualizar);
